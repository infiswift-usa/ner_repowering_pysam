...
print("="*70)
print("PURE PYSAM SIMULATION (PVWATTS V8) - 9-PCS GRANULAR MODEL")
print("USING HORIZONTAL METPV WEATHER DATA")
print("="*70)

# 1. Load the horizontal weather data
weather_file = 'metpv_horizontal_pysam.csv'
...
# 4. Results
print("\n" + "="*70)
print("FINAL RESULTS (9-PCS GRANULAR MODEL)")
print("="*70)
